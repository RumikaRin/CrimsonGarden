    ...
    >
      ...
      <motion.header variants={fadeUp} className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end border-b border-[var(--border-default)] pb-8">
        ...
        <button
          ...
          className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-[var(--accent)] px-5 text-xs font-bold uppercase tracking-wider text-[var(--accent-foreground)]"
        >
